    	...
    	<div class="wrap clearfix">
        	<div class="sidebar">
                ...
                <ul class="nav">
                	...
                	<%-- <li class="office current"><div class="nav-header"><a href="javascript:;" data-src="info_list.jsp" class="clearfix"><span>信息查询</span><i class="icon"></i></a></div></li>
                    <li class="gongwen"><div class="nav-header"><a href="javascript:;" data-src="statistical_analysis_list.jsp" class="clearfix"><span>统计分析</span><i class="icon"></i></a></div></li>
                    <li class="gongwen"><div class="nav-header"><a href="javascript:;" data-src="warning.jsp" class="clearfix"><span>警示提醒</span><i class="icon"></i></a></div></li> --%>
                </ul>
            </div>
            <div class="content">
