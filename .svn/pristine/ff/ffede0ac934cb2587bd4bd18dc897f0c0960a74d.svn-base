	...
	<div id="container">
		<div id="hd">
			<div class="hd-wrap clearfix">
				...
				<div class="toolbar"  >
					<div class="login-info clearfix" style=" width:200px;" >
						<div class="welcome clearfix" style=" width:100px;float:left; padding-left:10px; ">
							<span>欢迎您,</span><a href="javascript:;" class="user-name">${curUser.username}</a>
						</div>
						<div class="login-msg clearfix"  >
							<a href="#" class="msg-txt"  style=" width:50px;float:left; padding-left:15px; " onclick="show()">&nbsp;&nbsp;消息 </a><a
								href="javascript:;" class="msg-num"><%=MessageBox.messages.size()%></a>
						</div>
					</div>
					<div class="tool clearfix"  >
					<a href="javascript:;"class="quit-btn exit" style="float:right;">退出</a>
						<a href="javascript:;"class="help-btn" style="float:right;">帮助</a>
		...
		<div id="bd">
			<div class="wrap clearfix">
				<c:choose>
					<c:when test="${userType =='1'}">
						<iframe src="yunWei_preBaoBiao" id="iframe" width="100%"
		...
		<div id="ft" class="clearfix">
			<div class="ft-left">
				<span>Pengyue 实训管理系统</span> <em>Office&nbsp;System</em>
			</div>
			<div class="ft-right">
				<span>Automation</span> <em>1.0&nbsp;2017</em>
			</div>
		</div>
	</div>
