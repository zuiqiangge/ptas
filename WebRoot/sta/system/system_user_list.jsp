   ...
   <div class="modal fade" id="roleModal" role="dialog" aria-hidden="true">
    	<div class="modal-dialog">
	        <div class="modal-content">
	            <div class="modal-header">
	                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	                <h4 class="modal-title" id="roleModalTitle">设置角色</h4>
	            </div>
	            <div class="modal-body">
	            	<form id="roleForm">
	            	<input type="hidden" name="id"/>
	            	<c:forEach items="${jss}" var="js">
		           			<input type="checkbox" value="${js.id}" name="role"/>${js.jsmc}
		           	</c:forEach>
	            ...
	            <div class="modal-footer">
	                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
	                <button type="button" class="btn btn-primary" onclick="setRole()">提交更改</button>
	            </div>
	        </div><!-- /.modal-content -->
    	</div><!-- /.modal -->
	</div>
