    	...
    	<div class="wrap clearfix">
        	<div class="sidebar">
                ...
                <ul class="nav">
                	...
                	<%-- <li class="office current"><div class="nav-header"><a href="javascript:;" data-src="traning_order_list.jsp" class="clearfix"><span>组织实训预约</span><i class="icon"></i></a></div></li>
                    <li class="gongwen"><div class="nav-header"><a href="javascript:;" data-src="ordering_list.jsp" class="clearfix"><span>预约受理</span><i class="icon"></i></a></div></li> --%>
                </ul>
            </div>
            <div class="content">
