...
public class AttackLogServiceImpl implements AttackLogService {
	...
	public List<String> getAttackType() {
		return attackLogDao.getAttackType();
	}

	@Override
	public List<String> getAttackTypes() {
		return attackLogDao.getAttackTypes();
	}

	@Override
	public List<Map<Object,Object>> getHardIps() {
		return attackLogDao.getHardIps();
	}

	@Override
	public List<String> getRunStates() {
		return attackLogDao.getRunStates();
	}

	@Override
	public List<String> getRunStatesAndValues() {
		return attackLogDao.getRunStatesAndValues();
	}
